...
L["ElvUI is five or more revisions out of date. You can download the newest version from https://github.com/ElvUI-Cataclysm"] = "O ElvUI está rodando com cinco ou mais revisões desatualizadas. Você pode baixar a mais nova versão em https://github.com/ElvUI-Cataclysm"
L["ElvUI is out of date. You can download the newest version from https://github.com/ElvUI-Cataclysm"] = "O ElvUI está desatualizado. Você pode baixar a mais nova versão em https://github.com/ElvUI-Cataclysm"
...
L["For technical support visit us at https://github.com/ElvUI-Cataclysm."] = "Para suporte técnico visite-nos no site https://github.com/ElvUI-Cataclysm"
L["Frame"] = "Quadro"
...
L["Interrupted %s's |cff71d5ff|Hspell:%d|h[%s]|h|r!"] = "Interrompeu %s's |cff71d5ff|Hspell:%d|h[%s]|h|r!"
...
L["You are now finished with the installation process. If you are in need of technical support please visit us at https://github.com/ElvUI-Cataclysm"] = "O processo de instalação está agora terminado. Se precisar de suporte técnico por favor visite-nos no site https://github.com/ElvUI-Cataclysm"
...
--skuly
L["Notice: Auto sort disabled while in Combat."] = "Aviso: Classificação automática desativada durante o combate."
----------------------------------
