...
L["ElvUI is five or more revisions out of date. You can download the newest version from https://github.com/ElvUI-Cataclysm"] = "Ваш ElvUI устарел более, чем на 5 версий. Обновите его на https://github.com/ElvUI-Cataclysm"
L["ElvUI is out of date. You can download the newest version from https://github.com/ElvUI-Cataclysm"] = "ElvUI устарел. Вы можете скачать последнюю версию с https://github.com/ElvUI-Cataclysm"
...
L["For technical support visit us at https://github.com/ElvUI-Cataclysm."] = "За технической поддержкой обращайтесь на https://github.com/ElvUI-Cataclysm"
L["Frame"] = "Рамка"
...
L["Interrupted %s's |cff71d5ff|Hspell:%d|h[%s]|h|r!"] = "Прерван %s. Сбито |cff71d5ff|Hspell:%d|h[%s]|h|r!"
...
L["You are now finished with the installation process. If you are in need of technical support please visit us at https://github.com/ElvUI-Cataclysm"] = "Вы завершили процесс установки. Если Вам требуется техническая поддержка, посетите сайт https://github.com/ElvUI-Cataclysm"
 ...
 */moveui|r  -  Показать/скрыть фиксаторы для смены расположения различных элементов.
 */resetui|r  -  Сброс всех фреймов на из изначальные места.
 ...
 */luaerror|r ^on|r или ^off|r  -  Отключить все аддоны, кроме ElvUI.
  ВАЖНО: */luaerror|r ^off|r включит обратно все отключенные В ДАННОЙ СЕССИИ (без /rl) командой */luaerror|r ^on|r аддоны.
