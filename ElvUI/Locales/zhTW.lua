...
L["ElvUI is out of date. You can download the newest version from https://github.com/ElvUI-Cataclysm"] = "ElvUI 以過期. 你可以在 https://github.com/ElvUI-Cataclysm 下載到最新的版本."
...
L["Interrupted %s's |cff71d5ff|Hspell:%d|h[%s]|h|r!"] = "已打斷 %s 的 |cff71d5ff|Hspell:%d|h[%s]|h|r!"
