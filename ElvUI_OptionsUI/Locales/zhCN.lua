...
L["Core |cffff7000E|r|cffe5e3e3lvUI|r options."] = "核心|cffff7000E|r|cffe5e3e3lvUI|r配置"
L["Cosmetic"] = true
L["Count Font"] = true
...
L["Time To Hold"] = "停留时间"
L["Time X-Offset"] = "时间X偏移"
L["Time Y-Offset"] = "时间Y偏移"
L["Time"] = "时间"
...
L["ELVUI_DESC"] = "|cffff7000E|r|cffe5e3e3lvUI|r为一套功能完整, 可用来替换WoW原始界面的套件"
...
L["BINDING_NAME_MULTICASTACTIONBUTTON1"] = "大地图腾"
L["BINDING_NAME_MULTICASTACTIONBUTTON2"] = "火焰图腾"
L["BINDING_NAME_MULTICASTACTIONBUTTON3"] = "水图腾"
L["BINDING_NAME_MULTICASTACTIONBUTTON4"] = "空气图腾"
L["BLOCK"] = "格挡"
L["BOSS"] = "首领"
...
L["YELL"] = "大喊"
--skuly
L["Changing these settings will alter the placement of the nameplates, however the mouseover area does not follow. |cffff0000Use with caution!|r"] = "更改这些设置将改变铭牌的位置，但鼠标悬停区域不会随之改变。 |cffff0000谨慎使用！|r"
L["Vertical Offset"] = "垂直偏移"
L["Sets the vertical offset of the health bar."] = "设置生命条的垂直偏移。"
L["Horizontal Offset"] = "水平偏移"
L["Sets the left/right offset of the health bar."] = "设置生命条的左/右偏移。"

L["Auto Delete Junk"] = "自动删除垃圾"
L["Automatically delete Junk when looting."] = "抢劫时自动删除垃圾。"
L["Auto Delete List"] = "自动删除列表"
L["Automatically delete items in list."] = "自动删除列表中的项目。"
L["Displays item that was deleted in chat."] = "显示在聊天中删除的项目。"
L["Grey/Junk Item Value (Silver)"] = "灰色/垃圾物品价值（银色）"
L["If sell price of the item is less than this it will be deleted."] ="如果该商品的售价低于此价格，它将被删除。"
L["Check Value"] = "检查值"
L["Add Item by Name,ID or Drag/Drop"] = "按名称、ID 或拖/放添加项目"
L["Add an item to the delete list."] = "将项目添加到删除列表。"
L["Items to Delete"] = "要删除的项目"
L["Auto Sell Armor/Weapons"] = "自动销售盔甲/武器"
L["Automatically vendor green items when visiting a vendor."] = "拜访供应商时自动供应绿色物品。"
L["Include Soulbound"] = "包括灵魂束缚"
L["Sell Price Above (Gold)"] = "售价高于（黄金）"
L["Auto Sort"] = "自动排序"
L["Automatically sort after looting corpses."] = "抢劫尸体后自动排序。"
L["In-combat notice"] = "战斗中的通知"
L["This will print message in chat that you are in combat if you try to loot while in combat."] = "如果您在战斗中尝试抢劫，这将在聊天中打印您正在战斗的消息。"
L["Max Stack"] = "最大堆栈"
L["Display the Max Stack for item in the tooltip."] = "在工具提示中显示项目的最大堆栈。"
L["Max Stack Value"] = "最大堆栈值"
L["Display the Max Stack value for item in the tooltip."] = "在工具提示中显示项目的最大堆栈值。"