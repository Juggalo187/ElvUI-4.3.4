...
L["Core |cffff7000E|r|cffe5e3e3lvUI|r options."] = "Основные опции |cffff7000E|r|cffe5e3e3lvUI|r"
L["Cosmetic"] = true
L["Count Font"] = true
...
L["Quest XP"] = "Показать опыт за квесты"
...
L["Time X-Offset"] = "Отступ времени по X"
L["Time Y-Offset"] = "Отступ времени по Y"
L["Time"] = "Время"
...
L["ELVUI_DESC"] = "|cffff7000E|r|cffe5e3e3lvUI|r это аддон для полной замены пользовательского интерфейса World of Warcraft."
...
L["BINDING_NAME_MULTICASTACTIONBUTTON1"] = "Тотем земли"
L["BINDING_NAME_MULTICASTACTIONBUTTON2"] = "Тотем огня"
L["BINDING_NAME_MULTICASTACTIONBUTTON3"] = "Тотем воды"
L["BINDING_NAME_MULTICASTACTIONBUTTON4"] = "Тотем воздуха"
L["BLOCK"] = "Блок"
L["BOSS"] = "Босс"
...
L["YELL"] = "Крик"
--skuly
L["Changing these settings will alter the placement of the nameplates, however the mouseover area does not follow. |cffff0000Use with caution!|r"] = "Изменение этих настроек приведет к изменению расположения табличек, однако область наведения курсора мыши не изменится. |cffff0000Используйте с осторожностью!|r"
L["Vertical Offset"] = "Вертикальное смещение"
L["Sets the vertical offset of the health bar."] = "Устанавливает вертикальное смещение шкалы здоровья."
L["Horizontal Offset"] = "Горизонтальное смещение"
L["Sets the left/right offset of the health bar."] = "Устанавливает смещение шкалы здоровья влево/вправо."

L["Auto Delete Junk"] = "Автоматическое удаление мусора"
L["Automatically delete Junk when looting."] = "Автоматически удалять мусор при мародерстве."
L["Auto Delete List"] = "Автоудаление списка"
L["Automatically delete items in list."] = "Автоматически удалять элементы в списке."
L["Displays item that was deleted in chat."] = "Отображает элемент, который был удален в чате."
L["Grey/Junk Item Value (Silver)"] = "Ценность серого/мусорного предмета (серебро)"
L["If sell price of the item is less than this it will be deleted."] = "Если цена продажи предмета меньше этой, он будет удален."
L["Check Value"] = "Проверить значение"
L["Add Item by Name,ID or Drag/Drop"] = "Добавить элемент по имени, идентификатору или перетащить"
L["Add an item to the delete list."] = "Добавить элемент в список удаления."
L["Items to Delete"] = "Элементы для удаления"
L["Auto Sell Armor/Weapons"] = "Автопродажа брони/оружия"
L["Automatically vendor green items when visiting a vendor."] = "Автоматически продавать зеленые предметы при посещении продавца."
L["Include Soulbound"] = "Включить привязку души"
L["Sell Price Above (Gold)"] = "Цена продажи выше (золото)"
L["Auto Sort"] = "Автосортировка"
L["Automatically sort after looting corpses."] = "Автоматическая сортировка после обыска трупов."
L["In-combat notice"] = "Боевое извещение"
L["This will print message in chat that you are in combat if you try to loot while in combat."] = "Если вы попытаетесь грабить во время боя, в чате появится сообщение о том, что вы находитесь в бою."
L["Max Stack"] = "Макс Стек"
L["Display the Max Stack for item in the tooltip."] = "Отображать максимальный стек для элемента во всплывающей подсказке."
L["Max Stack Value"] = "Максимальное значение стека"
L["Display the Max Stack value for item in the tooltip."] = "Отобразить значение максимального стека для элемента во всплывающей подсказке."