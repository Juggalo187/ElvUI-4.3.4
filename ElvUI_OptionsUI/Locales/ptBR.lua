...
L["Core |cffff7000E|r|cffe5e3e3lvUI|r options."] = "Opções do núcleo do |cffff7000E|r|cffe5e3e3lvUI|r"
L["Cosmetic"] = true
L["Count Font"] = true
...
L["Time X-Offset"] = "Tempo (Eixo-X)"
L["Time Y-Offset"] = "Tempo (Eixo-Y)"
L["Time"] = "Tempo"
...
L["ELVUI_DESC"] = "O |cffff7000E|r|cffe5e3e3lvUI|r é um Addon completo de substituição da interface original do World of Warcraft."
...
L["BINDING_NAME_MULTICASTACTIONBUTTON1"] = "Totem da Terra"
L["BINDING_NAME_MULTICASTACTIONBUTTON2"] = "Totem do Fogo"
L["BINDING_NAME_MULTICASTACTIONBUTTON3"] = "Totem da Água"
L["BINDING_NAME_MULTICASTACTIONBUTTON4"] = "Totem do Ar"
L["BLOCK"] = "Bloquear"
L["BOSS"] = "Chefe"
...
L["YELL"] = "Gritar"
--skuly
L["Changing these settings will alter the placement of the nameplates, however the mouseover area does not follow. |cffff0000Use with caution!|r"] = "Alterar essas configurações alterará o posicionamento das placas de identificação, porém a área de passagem do mouse não segue. |cffff0000Use com cuidado!|r"
L["Vertical Offset"] = "Deslocamento vertical"
L["Sets the vertical offset of the health bar."] = "Define o deslocamento vertical da barra de integridade."
L["Horizontal Offset"] = "Deslocamento horizontal"
L["Sets the left/right offset of the health bar."] = "Define o deslocamento esquerdo/direito da barra de integridade."
L["Auto Delete Junk"] = "Excluir lixo automaticamente"
L["Automatically delete Junk when looting."] = "Excluir lixo automaticamente ao saquear."
L["Auto Delete List"] = "Lista de exclusão automática"
L["Automatically delete items in list."] = "Excluir itens automaticamente da lista."
L["Displays item that was deleted in chat."] = "Exibe item que foi excluído no chat."
L["Grey/Junk Item Value (Silver)"] = "Valor do item cinza/lixo (prata)"
L["If sell price of the item is less than this it will be deleted."] = "Se o preço de venda do item for inferior a este, ele será excluído."
L["Check Value"] = "Verificar valor"
L["Add Item by Name,ID or Drag/Drop"] = "Adicionar item por nome, ID ou arrastar/soltar"
L["Add an item to the delete list."] = "Adicionar um item à lista de exclusão."
L["Items to Delete"] = "Itens a serem excluídos"
L["Auto Sell Armor/Weapons"] = "Venda Automática de Armaduras/Armas"
L["Automatically vendor green items when visiting a vendor."] = "Vende itens verdes automaticamente ao visitar um fornecedor."
L["Include Soulbound"] = "Incluir Soulbound"
L["Sell Price Above (Gold)"] = "Preço de venda acima (ouro)"
L["Auto Sort"] = "Classificação automática"
L["Automatically sort after looting corpses."] = "Classificar automaticamente após saquear cadáveres."
L["In-combat notice"] = "Aviso em combate"
L["This will print message in chat that you are in combat if you try to loot while in combat."] = "Isso exibirá uma mensagem no chat informando que você estará em combate se tentar saquear durante o combate."
L["Max Stack"] = "Pilha Máxima"
L["Display the Max Stack for item in the tooltip."] = "Exibir a pilha máxima do item na dica de ferramenta."
L["Max Stack Value"] = "Valor máximo da pilha"
L["Display the Max Stack value for item in the tooltip."] = "Exibir o valor Max Stack do item na dica de ferramenta."