...
L["Add an Item Name or ID to the list."] = true
...
L["An X offset (in pixels) to be used when anchoring new frames."] = "Un desplazamiento X (en píxeles) que se utilizará al anclar nuevos cuadros."
L["An Y offset (in pixels) to be used when anchoring new frames."] = "Un desplazamiento Y (en píxeles) que se utilizará al anclar nuevos cuadros."
L["Anchor Point"] = "Punto de Fijación"
L["ANCHOR_CURSOR"] = true
L["ANCHOR_CURSOR_LEFT"] = "Izquierda del cursor"
L["ANCHOR_CURSOR_RIGHT"] = "Derecha del cursor"
...
L["Applies the primary texture to all statusbars."] = "Aplica la textura principal a todas las barras de estado."
L["Apply Font To All"] = "Aplicar el Tipo de Letra a todos"
L["Apply Texture To All"] = "Aplicar la Textura a todos"
...
L["Aura Speed"] = "Velocidad del Aura"
...
L["Bag 3"] = "Bolsa 3"
L["Bag 4"] = "Bolsa 4"
L["Bag Sorting"] = "Clasificación de Bolsas"
...
L["Blacklist Modifier"] = "Modificador de la lista negra"
...
L["Choose when you want the tooltip to show in combat. If a modifer is chosen, then you need to hold that down to show the tooltip."] = "Elige cuándo quieres que se muestre la información sobre herramientas en el combate. Si se elige un modificador, hay que mantenerlo pulsado para que se muestre la información sobre herramientas."
L["Choose when you want the tooltip to show. If a modifer is chosen, then you need to hold that down to show the tooltip."] = "Elija cuándo quiere que se muestre la información sobre herramientas. Si se elige un modificador, hay que mantenerlo pulsado para que se muestre la información sobre herramientas."
...
L["Clickable Width"] = "Anchura de Clickable"
...
L["Comparison Font Size"] = "Comparación del Tamaño de la Letra"
...
L["Core |cffff7000E|r|cffe5e3e3lvUI|r options."] = true
L["Cosmetic"] = true
L["Count Font"] = true
...
L["ELVUI_DESC"] = "|cffff7000E|r|cffe5e3e3lvUI|r es un addon que reemplaza la interfaz completa de World of Warcraft."
...
L["BINDING_NAME_MULTICASTACTIONBUTTON1"] = "Tótem de Tierra"
L["BINDING_NAME_MULTICASTACTIONBUTTON2"] = "Tótem de Fuego"
L["BINDING_NAME_MULTICASTACTIONBUTTON3"] = "Tótem de Agua"
L["BINDING_NAME_MULTICASTACTIONBUTTON4"] = "Tótem de Aire"
L["BLOCK"] = "Bloqueo"
L["BOSS"] = "Jefe"
...
L["INVTYPE_CHEST"] = "Pecho"
L["INVTYPE_CLOAK"] = "Espalda"
L["INVTYPE_FEET"] = "Pies"
L["INVTYPE_FINGER1"] = "Dedo 1"
L["INVTYPE_FINGER2"] = "Dedo 2"
L["INVTYPE_HAND"] = "Manos"
L["INVTYPE_HEAD"] = "Cabeza"
L["INVTYPE_LEGS"] = "Piernas"
L["INVTYPE_NECK"] = "Cuello"
L["INVTYPE_RANGED"] = "A distancia"
L["INVTYPE_SHOULDER"] = "Hombro"
L["INVTYPE_TABARD"] = "Tabardo"
L["INVTYPE_TRINKET1"] = "Abalorio 1"
L["INVTYPE_TRINKET2"] = "Abalorio 2"
L["INVTYPE_WAIST"] = "Cintura"
L["INVTYPE_WEAPONMAINHAND"] = "Mano derecha"
L["INVTYPE_WEAPONOFFHAND"] = "Mano izquierda"
L["INVTYPE_WRIST"] = "Muñecas"
...
L["YELL"] = "Gritar"
--skuly
L["Changing these settings will alter the placement of the nameplates, however the mouseover area does not follow. |cffff0000Use with caution!|r"] = "Cambiar esta configuración alterará la ubicación de las placas de identificación; sin embargo, el área al pasar el mouse no sigue. |cffff0000¡Usar con precaución!|r"
L["Vertical Offset"] = "Desplazamiento vertical"
L["Sets the vertical offset of the health bar."] = "Establece el desplazamiento vertical de la barra de salud."
L["Horizontal Offset"] = "Desplazamiento horizontal"
L["Sets the left/right offset of the health bar."] = "Establece el desplazamiento izquierda/derecha de la barra de salud."
L["Auto Delete Junk"] = "Eliminación automática de basura"
L["Automatically delete Junk when looting."] = "Eliminar basura automáticamente al saquear"
L["Auto Delete List"] = "Lista de eliminación automática"
L["Automatically delete items in list."] = "Eliminar automáticamente elementos de la lista."
L["Displays item that was deleted in chat."] = "Muestra el elemento que se eliminó en el chat."
L["Grey/Junk Item Value (Silver)"] = "Valor del artículo gris/basura (plata)"
L["If sell price of the item is less than this it will be deleted."] = "Si el precio de venta del artículo es inferior a este, se eliminará."
L["Check Value"] = "Verificar valor"
L["Add Item by Name,ID or Drag/Drop"] = "Agregar elemento por nombre, ID o arrastrar/soltar"
L["Add an item to the delete list."] = "Agregue un elemento a la lista de eliminación."
L["Items to Delete"] = "Elementos para eliminar"
L["Auto Sell Armor/Weapons"] = "Venta automática de armaduras/armas"
L["Automatically vendor green items when visiting a vendor."] = "Distribuya automáticamente artículos ecológicos cuando visite a un proveedor."
L["Include Soulbound"] = "incluir encuadernado"
L["Sell Price Above (Gold)"] = "Precio de venta superior (oro)"
L["Auto Sort"] = "Ordenación automática"
L["Automatically sort after looting corpses."] = "Clasificar automáticamente después de saquear cadáveres."
L["In-combat notice"] = "Aviso en combate"
L["This will print message in chat that you are in combat if you try to loot while in combat."] = "Esto imprimirá un mensaje en el chat indicando que estás en combate si intentas saquear mientras estás en combate."
L["Max Stack"] = "Pila máxima"
L["Display the Max Stack for item in the tooltip."] = ""
L["Max Stack Value"] = "Muestre la pila máxima del elemento en la información sobre herramientas."
L["Display the Max Stack value for item in the tooltip."] = "Muestra el valor de pila máxima para el elemento en la información sobre herramientas."