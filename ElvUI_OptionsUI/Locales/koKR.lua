...
L["|cffFF0000Warning:|r Changing options in this section will apply to all Buff Indicator auras. To change only one Aura, please click Configure Auras and change that specific Auras settings. If Profile Specific is selected it will apply to that filter set."] = "|cffFF0000경고:|r 이 항목의 변경 옵션은 모든 버프 표시기 오라에 적용됩니다.\n\n하나의 오라만 변경하려면 '오라 설정'을 클릭하고 특정 오라 설정을 변경하십시오.\n\n'프로필 설정'을 선택하면 해당 필터 세트에 적용됩니다."
...
L["Set the filter type. Blacklist will hide any auras in the list and show all others. Whitelist will show any auras in the filter and hide all others."] = "필터 종류를 지정합니다. 블랙리스트는 목록에 있는 오라는 모두 숨기고 나머지는 전부 표시합니다. 화이트리스트는 목록에 있는 오라는 모두 표시하고 나머지는 전부 숨깁니다."
...
L["Time X-Offset"] = "시간 x 좌표"
L["Time Y-Offset"] = "시간 y 좌표"
L["Time"] = "시간"
...
L["Use the profile specific filter Buff Indicator (Profile) instead of the global filter Buff Indicator."] = "일반공통 필터 오라(버프/디버프) 표시기 대신 프로필 특정 필터 버프 표시기를 사용합니다.(프로필별로 저장) "
...
L["ELVUI_DESC"] = "|cffff7000E|r|cffe5e3e3lvUI|r는 WoW에서 지원하는 대부분의 기능을 대체하는 통합 애드온입니다."
...
L["BINDING_NAME_MULTICASTACTIONBUTTON1"] = "대지의 토템"
L["BINDING_NAME_MULTICASTACTIONBUTTON2"] = "불의 토템"
L["BINDING_NAME_MULTICASTACTIONBUTTON3"] = "물의 토템"
L["BINDING_NAME_MULTICASTACTIONBUTTON4"] = "바람의 토템"
L["BLOCK"] = "방패 막기"
L["BOSS"] = "우두머리"
...
L["INVTYPE_CLOAK"] = "등"
L["INVTYPE_FEET"] = "발"
L["INVTYPE_FINGER1"] = "손가락 1"
L["INVTYPE_FINGER2"] = "손가락 2"
L["INVTYPE_HAND"] = "손"
L["INVTYPE_HEAD"] = "머리"
L["INVTYPE_LEGS"] = "다리"
L["INVTYPE_NECK"] = "목"
L["INVTYPE_RANGED"] = "원거리 장비"
L["INVTYPE_SHOULDER"] = "어깨"
L["INVTYPE_TABARD"] = "겉옷"
L["INVTYPE_TRINKET1"] = "장신구 1"
L["INVTYPE_TRINKET2"] = "장신구 2"
L["INVTYPE_WAIST"] = "허리"
L["INVTYPE_WEAPONMAINHAND"] = "주장비"
L["INVTYPE_WEAPONOFFHAND"] = "보조장비"
L["INVTYPE_WRIST"] = "손목"
...
L["YELL"] = "외침"
--skuly
L["Changing these settings will alter the placement of the nameplates, however the mouseover area does not follow. |cffff0000Use with caution!|r"] = "이러한 설정을 변경하면 명판의 위치가 변경되지만 마우스 오버 영역은 따르지 않습니다. |cffff0000주의해서 사용하세요!|r"
L["Vertical Offset"] = "수직 오프셋"
L["Sets the vertical offset of the health bar."] = "체력 표시줄의 수직 오프셋을 설정합니다."
L["Horizontal Offset"] = "수평 오프셋"
L["Sets the left/right offset of the health bar."] = "체력바의 왼쪽/오른쪽 오프셋을 설정합니다."
L["Auto Delete Junk"] = "정크 자동 삭제"
L["Automatically delete Junk when looting."] = "약탈 시 정크를 자동으로 삭제합니다."
L["Auto Delete List"] = "자동 삭제 목록"
L["Automatically delete items in list."] = "목록의 항목을 자동으로 삭제합니다."
L["Displays item that was deleted in chat."] = "채팅에서 삭제된 항목을 표시합니다."
L["Grey/Junk Item Value (Silver)"] = "회색/정크 아이템 가격(실버)"
L["If sell price of the item is less than this it will be deleted."] = "아이템의 판매 가격이 이 값보다 낮으면 삭제됩니다."
L["Check Value"] = "값 확인"
L["Add Item by Name,ID or Drag/Drop"] = "이름, ID 또는 드래그/드롭으로 항목 추가"
L["Add an item to the delete list."] = "삭제 목록에 항목을 추가하세요."
L["Items to Delete"] = "삭제할 항목"
L["Auto Sell Armor/Weapons"] = "방어구/무기 자동 판매"
L["Automatically vendor green items when visiting a vendor."] = "상점 방문 시 자동으로 녹색 품목을 판매합니다."
L["Include Soulbound"] = "경계 포함"
L["Sell Price Above (Gold)"] = "판매 가격 (골드) 이상"
L["Auto Sort"] = "자동 정렬"
L["Automatically sort after looting corpses."] = "시체를 약탈한 후 자동으로 정렬합니다."
L["In-combat notice"] = "전투 중 알림"
L["This will print message in chat that you are in combat if you try to loot while in combat."] = "전투 중 약탈을 시도하면 전투 중이라는 메시지가 채팅에 인쇄됩니다."
L["Max Stack"] = "맥스 스택"
L["Display the Max Stack for item in the tooltip."] = "툴팁에 아이템의 최대 스택을 표시합니다."
L["Max Stack Value"] = "최대 스택 값"
L["Display the Max Stack value for item in the tooltip."] = "툴팁에 아이템의 최대 스택 값을 표시합니다."
