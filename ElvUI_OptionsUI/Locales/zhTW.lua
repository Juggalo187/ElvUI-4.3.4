...
L["Core |cffff7000E|r|cffe5e3e3lvUI|r options."] = "核心 |cffff7000E|r|cffe5e3e3lvUI|r 選項"
L["Cosmetic"] = true
L["Count Font"] = true
...
L["Time To Hold"] = "停留時間"
L["Time X-Offset"] = "時間X軸偏移"
L["Time Y-Offset"] = "時間Y軸偏移"
L["Time"] = "時間"
...
L["ELVUI_DESC"] = "|cffff7000E|r|cffe5e3e3lvUI|r 為一套功能完整, 可用來替換 WoW 原始介面的 UI 套件."
...
L["BINDING_NAME_MULTICASTACTIONBUTTON1"] = "大地圖騰"
L["BINDING_NAME_MULTICASTACTIONBUTTON2"] = "火焰圖騰"
L["BINDING_NAME_MULTICASTACTIONBUTTON3"] = "水之圖騰"
L["BINDING_NAME_MULTICASTACTIONBUTTON4"] = "風之圖騰"
L["BLOCK"] = "格擋"
L["BOSS"] = "首領"
...
L["INVTYPE_CLOAK"] = "背部"
L["INVTYPE_FEET"] = "腳"
L["INVTYPE_FINGER1"] = "手指 1"
L["INVTYPE_FINGER2"] = "手指 2"
L["INVTYPE_HAND"] = "手"
L["INVTYPE_HEAD"] = "頭部"
L["INVTYPE_LEGS"] = "腿部"
L["INVTYPE_NECK"] = "頸部"
...
L["YELL"] = "大喊"
--skuly
L["Changing these settings will alter the placement of the nameplates, however the mouseover area does not follow. |cffff0000Use with caution!|r"] = "更改這些設定將改變銘牌的位置，但滑鼠懸停區域不會隨之改變。 |cffff0000謹慎使用！|r"
L["Vertical Offset"] = "垂直偏移"
L["Sets the vertical offset of the health bar."] = "設定生命條的垂直偏移。"
L["Horizontal Offset"] = "水平偏移"
L["Sets the left/right offset of the health bar."] = "設定生命條的左/右偏移。"
L["Auto Delete Junk"] = "自動刪除垃圾"
L["Automatically delete Junk when looting."] = "搶劫時自動刪除垃圾。"
L["Auto Delete List"] = "自動刪除清單"
L["Automatically delete items in list."] = "自動刪除清單中的項目。"
L["Displays item that was deleted in chat."] = "顯示在聊天中刪除的項目。"
L["Grey/Junk Item Value (Silver)"] = "灰色/垃圾物品價值（銀色）"
L["If sell price of the item is less than this it will be deleted."] = "如果該商品的售價低於此價格，它將被刪除。"
L["Check Value"] = "檢查值"
L["Add Item by Name,ID or Drag/Drop"] = "按名稱、ID 或拖曳/放新增項目"
L["Add an item to the delete list."] = "將項目新增至刪除清單。"
L["Items to Delete"] = "要刪除的項目"
L["Auto Sell Armor/Weapons"] = "自動銷售盔甲/武器"
L["Automatically vendor green items when visiting a vendor."] = "拜訪供應商時自動供應綠色物品。"
L["Include Soulbound"] = "包括綁定"
L["Sell Price Above (Gold)"] = "售價高於（黃金）"
L["Auto Sort"] = "自動排序"
L["Automatically sort after looting corpses."] = "搶劫屍體後自動排序。"
L["In-combat notice"] = "戰鬥中的通知"
L["This will print message in chat that you are in combat if you try to loot while in combat."] = "如果您在戰鬥中嘗試搶劫，這將在聊天中打印您正在戰鬥的消息。"
L["Max Stack"] = "最大堆疊"
L["Display the Max Stack for item in the tooltip."] = "在工具提示中顯示項目的最大堆疊。"
L["Max Stack Value"] = "最大堆疊值"
L["Display the Max Stack value for item in the tooltip."] = "在工具提示中顯示項目的最大堆疊值。"